    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" name="newClient" action="classes/ClientController.php?option=save">

             <input id="idClient"  type="text" name="idClient" value="<?php echo $row['nextid']; ?>" hidden/> 
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div id="gender" class="btn-group" data-toggle="buttons">
                    <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                      <input type="radio" id="gender" name="gender" value="M"> &nbsp; Masculino &nbsp;
                    </label>
            ...
            <div id="PJ"  style="display: none;">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="legalPersonRegistration" class="form-control col-md-7 col-xs-12" type="text" name="legalPersonRegistration" required="required">
                </div>
              </div>
